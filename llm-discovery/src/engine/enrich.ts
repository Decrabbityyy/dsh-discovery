...
/** The id-keyed index over every provider the installed pi-ai catalog ships, built once per process. */
...
/** Fill the fields one discovered model left undisclosed from the bundled catalog. */
